defmodule Sciencecritic.PaperQA.DemoSeeds do
  ...
  @examples [
    %{
      ...
      selected_text: "based solely on attention mechanisms",
      question:
    ...
    %{
      ...
      selected_text: "precludes parallelization within training examples",
    ...
    %{
      ...
      selected_text: "Multi-head attention allows the model to jointly attend to information",
    ...
    %{
      ...
      selected_text: "our model contains no recurrence and no convolution",
    ...
    %{
      ...
      selected_text: "the easier it is to learn long-range dependencies",
    ...
    %{
      ...
      selected_text: "better BLEU scores than previous state-of-the-art",
    ...
    %{
      ...
      selected_text: "if the Transformer can generalize to other tasks",
